...
\journal{[-options.journal | replace("\\", "\\textbackslash{}") | replace("{", "\\{") | replace("}", "\\}") | replace("&", "\\&") | replace("%", "\\%") | replace("$", "\\$") | replace("#", "\\#") | replace("_", "\\_") | replace("~", "\\textasciitilde{}") | replace("^", "\\textasciicircum{}")-]}
[# endif #]
...
[# endif #]
[# if author.note #]
\fntext[[-fnp-][-loop.index-]]{[-author.note | replace("\\", "\\textbackslash{}") | replace("{", "\\{") | replace("}", "\\}") | replace("&", "\\&") | replace("%", "\\%") | replace("$", "\\$") | replace("#", "\\#") | replace("_", "\\_") | replace("~", "\\textasciitilde{}") | replace("^", "\\textasciicircum{}")-]}
[# endif #]
[# endfor #]
